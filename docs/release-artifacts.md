# v1.3.0-beta.2 release artifacts

The v1.3.0-beta.2 artifact flow separates preparation, approval, publication, and verification. A locally built package may be prepared and validated without being approved, signed, or distributable. The current decision template is [the v1.3.0-beta.2 packet](releases/V1.3.0-beta.2_RELEASE_DECISION.md). Earlier candidate packets remain immutable historical evidence.
...
```bash
npm run release:stage -- release/v1.3.0-beta.2
```
