...
assert.deepEqual(manifest.inputs.verificationProgress.extensions, ['.json']);
assert.equal(manifest.inputs.verificationProgress.maxBytes, 10 * 1024 * 1024);
assert.equal(manifest.inputs.verificationProgress.maxDepth, 64);
