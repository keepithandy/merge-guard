...
assert.equal(valid.supportedCoreRange.min, '1.0.0');
...
const incompatible = await runPluginConformance({ manifest, pluginPath: path.join(fixtureRoot, 'valid-plugin.js'), coreVersion: '0.1.0' });
